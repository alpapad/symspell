 ...
 * 
 * This implementation uses the iterative approach with two matrix rows. Case
 * insensitive.
 * 
 * See
 * <a href="https://en.wikipedia.org/wiki/Levenshtein_distance">Wikipedia</a>.
 * 
 * <p>
	...
	public int calculateEditDistance(String str1, String str2) {
		...
		for (int rowIndex = 1; rowIndex < str2RowLength; rowIndex++) {
			...
			for (int colIndex = 1; colIndex < str1RowLength; colIndex++) {
				...
				currentRow[colIndex] = Math.min(Math.min(insertionCost, deletionCost), substitutionCost);
			}
