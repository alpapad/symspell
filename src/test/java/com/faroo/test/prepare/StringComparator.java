...
/**
 * 
 * @author https://github.com/CSSIP-AIR/torchRL/blob/master/src/main/java/torch/comparators/StringComparator.java
 *
 */
public class StringComparator {
    ...
    public int compare(String field1, String field2) {
        double weight = fuzzyMatch(field1, field2);
