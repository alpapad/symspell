...
import com.faroo.symspell.map.LongObjConsumer;
import com.faroo.symspell.map.LongObjMap;
 ...
 */
public class CustomCompactWordIndex implements IWordIndex, Externalizable {
     ...
     */
    private LongObjMap<Object> dictionary;
    ...
    public void commit() {
        dictionary.shrink();
        // dictionary = HashLongObjMaps.getDefaultFactory().newImmutableMap(dictionary);
    }
...
//        this.dictionary.shrink();
        ...
        this.dictionary.forEach(new LongObjConsumer<Object>() {
            @Override
            public void accept(long key, Object value) {
                try {
...
//        // VERSION
        ...
        this.dictionary = new LongObjMap<Object>(size, .9f);
