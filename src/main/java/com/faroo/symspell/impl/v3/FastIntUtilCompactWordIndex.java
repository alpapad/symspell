...
import static com.faroo.symspell.hash.MurmurHash.hash;
 ...
 */
public class FastIntUtilCompactWordIndex implements IWordIndex, Externalizable {
     ...
     */
    private Int2ObjectOpenHashMap<Object> dictionary = new Int2ObjectOpenHashMap<>(100_000, 1f);
    ...
    public FastIntUtilCompactWordIndex(int editDistanceMax, Verbosity verbosity) {
        super();
    ...
    public void readExternal(ObjectInput in) throws IOException, ClassNotFoundException {
        ...
        dictionary = new Int2ObjectOpenHashMap<>(size, 1f);
